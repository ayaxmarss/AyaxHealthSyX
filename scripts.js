...

{
  ...
  synonyms: [
   ...
   { CID: 'W82', NAME: 'Condição relacionada ao término da gestação', SYNONYMS: ['condição relacionada ao término da gestação'] }, { CID: 'W83', NAME: 'Condição relacionada ao término da gestação', SYNONYMS: ['condição relacionada ao término da gestação'] }, { CID: 'W90', NAME: 'Condição relacionada ao término da gestação', SYNONYMS: ['condição relacionada ao término da gestação'] }, { CID: 'W91', NAME: 'Condição relacionada ao término da gestação', SYNONYMS: ['condição relacionada ao término da gestação'] }, { CID: '002', NAME: 'Infecção congênita', SYNONYMS: ['infecção congênita'] }, { CID: '003', NAME: 'Infecção congênita', SYNONYMS: ['infecção congênita'] }, { CID: '060', NAME: 'Trabalho de parto prematuro', SYNONYMS: ['trabalho de parto prematuro'] }, { CID: '061', NAME: 'Ruptura prematura de membranas', SYNONYMS: ['ruptura prematura de membranas'] }, { CID: '064', NAME: 'Distúrbios hipertensivos na gravidez', SYNONYMS: ['distúrbios hipertensivos na gravidez'] }, { CID: '065', NAME: 'Diabetes gestacional', SYNONYMS: ['diabetes gestacional'] }, { CID: '068', NAME: 'Morte fetal intrauterina', SYNONYMS: ['morte fetal intrauterina'] }, { CID: '070', NAME: 'Aborto espontâneo', SYNONYMS: ['aborto espontâneo'] }, { CID: '071', NAME: 'Aborto retido', SYNONYMS: ['aborto retido'] }, { CID: '075.0', NAME: 'Condições do recém-nascido', SYNONYMS: ['condições do recém-nascido'] }, { CID: 'Z37.0', NAME: 'Nascimento único, vivo', SYNONYMS: ['nascimento único, vivo'] }, { CID: 'Z37.1', NAME: 'Nascimento único, morto', SYNONYMS: ['nascimento único, morto'] }, { CID: 'Z37.2', NAME: 'Nascimentos múltiplos, todos vivos', SYNONYMS: ['nascimentos múltiplos, todos vivos'] }, { CID: 'Z38', NAME: 'Nascido no hospital', SYNONYMS: ['nascido no hospital'] }, { CID: 'Z39', NAME: 'Cuidados pós-parto', SYNONYMS: ['cuidados pós-parto'] } ];
